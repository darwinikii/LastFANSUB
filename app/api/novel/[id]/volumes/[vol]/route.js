...
export async function GET(req, { params }) {
  if (!fs.existsSync("./app/data/" + params.id + "/volumes/" + params.vol + "/data.json")) return notFound()
  ...
  var volumeData = JSON.parse(fs.readFileSync("./app/data/" + params.id + "/volumes/" + params.vol + "/data.json"))
  var novelData = JSON.parse(fs.readFileSync("./app/data/" + params.id + "/data.json"))
