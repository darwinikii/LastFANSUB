...
export default function Page({ params }) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between lg:p-24 overflow-hidden">
      ...
      <div className="max-w-4xl mt-10 mb-2 m-50 border-gray-300 from-zinc-200 p-2 lg:pb-6 lg:pt-8 backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:bg-zinc-800/30">
        <MangaReader
            id={params.id}
            chap={params.chap}
        />
