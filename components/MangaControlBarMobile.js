  ...
  return (
    <div className={className} style={style}>
      ...
      <div className="w-full my-1">
        <MangaReaderChoices className="my-1 w-full text-gray-900 text-sm rounded-lg block p-2.5 placeholder-gray-900 text-white" />
        <select id="chapterSelect" onChange={handleOnChange} className="my-1 w-full text-gray-900 text-sm rounded-lg block p-2.5 placeholder-gray-900 text-white">
          {list}
        </select>
      </div>
    </div>
