  ...
  if (vol == undefined) return (
    <div className={className} style={style}>
      ...
      <div className="flex flex-col justify-between mx-1 w-full">
        <div className='flex flex-col items-center'>
          <h2 className="flex items-center xl:text-4xl font-semibold">
            {data["names"][0]}
          ...
          <h3 className="flex w-full justify-between mt-8 my-2 xl:text-xl font-normal">
            Yazar: <a href={data["author"]["URL"]} className="ml-2 font-semibold">{data["author"]["name"]}</a>
          </h3>
          <h3 className="flex w-full justify-between my-2 xl:text-xl font-normal">
          ...
          {data["translator"] ? <h3 className="flex w-full justify-between my-2 xl:text-xl font-normal">Çeviren: <a className="mx-2 font-medium truncate overflow-hidden">{data["translator"]}</a></h3> : ""}
    ...
    <div className={className} style={style}>
      ...
      <div className="flex flex-col items-center mx-1 w-full">
        <Link href={'/' + type + '/' + id} className="flex items-center text-lg xl:text-4xl font-semibold">
          {data["novelData"]["names"][0]}
        </Link>
        <h3 className="xl:my-2 xl:text-xl font-medium text-gray-300 text-center text-balance">
          Volume{' ' + data.id}
        </h3>
        <h3 className="flex w-full justify-between mt-8 my-2 xl:text-xl font-normal">
          Yayın Tarihi: 
